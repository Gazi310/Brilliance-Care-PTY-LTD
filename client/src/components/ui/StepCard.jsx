...
export default function StepCard({ step, title, className = '', children }) {
  return (
    <div
      className={`flex flex-row flex-wrap items-center gap-x-3.5 gap-y-2.5 rounded-card bg-white p-6 lg:flex-col lg:flex-nowrap lg:items-start lg:gap-3 lg:p-7 ${className}`}
    >
      {step != null && (
