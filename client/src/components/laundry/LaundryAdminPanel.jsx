...
/**
 * Laundry service manager. Renders inline on the /admin/services page
 * (`inline`), or as a slide-over drawer (default) for legacy callers.
 */
export default function LaundryAdminPanel({ open, onClose, services, onSave, onDelete, onCreate, savingId, notify, inline = false }) {
  ...
  // Inline mode: rendered directly inside the /admin/services page.
